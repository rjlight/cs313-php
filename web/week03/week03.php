...
<center><div>
    <input type="checkbox" name="items[]" name="hat" value="Hat $15.99"> Hat $15.99<br>
    <input type="button" class="button" value="Add items to cart" onclick="addItem(Hat)"><br><br>
    <input type="checkbox" name="items[]" name="scarf" value="Scarf $13.99"> Scarf $13.99<br>
    <input type="button" class="button" value="Add items to cart" onclick="addItem(Hat)"><br><br>
    <input type="checkbox" name="items[]" name="socks" value="Socks $9.99"> Socks $9.99<br>
    <input type="button" class="button" value="Add items to cart" onclick="addItem(Hat)"><br><br>
    <input type="checkbox" name="items[]" name="hoodie" value="Hoodie $34.99"> Hoodie $34.99<br>
