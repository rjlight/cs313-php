...
function checkStudent() { //to add an edit field for additional students
    ...
    if (document.getElementsByName("student2").innerHTML != null) {
        ...
        if (document.getElementsByName("student3").innerHTML != null) {
            ...
            if (document.getElementsByName("student4").innerHTML != null) {
