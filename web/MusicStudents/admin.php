...
<div class="border">
    ...
    <?php
        ...
        if($username="admin" && $password="admin789") {
            ...
            $userArray($count); //create a userArray with the size of the # of users
            $index = 0;
            ...
            echo 'Please enter the account number you would like to see the details for: <br><input type=text name=account>';
